...
<head>
    ...
    <link rel="stylesheet" href="/css/setChangeLocation.css" type="text/css"/>
</head>
<body>

<div id="Container">
    <div style="width: 100%; margin-top: 70px; display: flex; justify-content: space-between">
        <span id="titleSpan">환승 역 설정</span>
        <div id="resetButton" onclick="resetChange()">환승 초기화</div>
    </div>
...
<script>
    ...
    function onClickStation(station) {
        ...
        $.ajax({
            ...
            alert("환승 역이 " + station.stationName + " 역으로 등록되었습니다.");
